...
activities = {
    ...
    "Soccer Club": {
        "description": "Practice teamwork and play friendly matches on the field",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 22,
        "participants": ["liam@mergington.edu", "ava@mergington.edu"]
    },
    "Basketball Team": {
        "description": "Train for interscholastic basketball games and drills",
    ...
    "Drama Club": {
        "description": "Rehearse and perform school plays and improv exercises",
